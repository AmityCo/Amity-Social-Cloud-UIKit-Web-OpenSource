...
export const TextEditor = forwardRef<TextEditorHandle, TextEditorProps>(
  (
    ...
    const [isMentionHighlightActive, setIsMentionHighlightActive] = useState(false);

    const onQueryChange = useCallback(
      createQueryChangeHandler((query) => {
        setIsMentionHighlightActive(false);
              ...
              menuRenderFn={(
                ...
                return (
                  <MentionMenu<MentionData | ProductMentionData>
                    ...
                    selectedIndex={isMentionHighlightActive ? selectedIndex : null}
                    setHighlightedIndex={(index) => {
                      setIsMentionHighlightActive(true);
                      setHighlightedIndex(index);
                    }}
