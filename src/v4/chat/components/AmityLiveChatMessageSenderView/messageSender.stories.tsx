...
import AmityLiveChatMessageSenderView from '.';

export default {
  title: 'V4/AmityMessageSenderView',
};
...
const SampleMessageSenderView = () => {
  ...
  return (
    <div style={{ background: 'white' }}>
      <AmityLiveChatMessageSenderView containerRef={ref} message={messages[0]} action={{}} />
    </div>
  );
};
...
export const LiveChatStory = {
  ...
  name: 'AmityLiveChatMessageSender',
};
