export enum Permissions {
  ...
  DeleteChannelPermission = 'DELETE_CHANNEL',
  ManageNotificationNetworkSettingPermission = 'MANAGE_NOTIFICATION_NETWORK_SETTING',
  ...
  MuteUserInsideChannelPermission = 'MUTE_USER_INSIDE_CHANNEL',
  BanUserFromChannelPermission = 'BAN_USER_FROM_CHANNEL',
