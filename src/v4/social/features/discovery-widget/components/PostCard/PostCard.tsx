...
import { useMaxBodyLines } from '~/v4/social/features/discovery-widget/hooks';
import type { DiscoveryWidgetLayout } from '~/v4/social/features/discovery-widget/types';
import {
...
export const PostCard = forwardRef<HTMLDivElement, PostCardProps>(function PostCard(
  ...
  const componentId = COMPONENT_ID.DISCOVERY_WIDGET_POST_CARD_COMPONENT;
