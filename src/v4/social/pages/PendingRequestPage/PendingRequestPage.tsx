...
export const PendingRequestPage = ({ community }: PendingRequestPageProps) => {
  ...
  if (
    ...
    visibleTabs.push({
      ...
      label: resolveString('amity_social_tab_tab_posts_count', renderAmouts(reviewingPosts.length)),
  ...
  if (
    ...
    visibleTabs.push({
      ...
      label: resolveString(
        'amity_social_tab_tab_join_requests_count',
        renderAmouts(joinRequestsCount),
      ),
      ...
      >
        <div className={styles.pendingRequestsPage__topBar}>
          ...
          <div className={styles.pendingRequestsPage__titleWrap}>
            <Title
              pageId={pageId}
              titleClassName={styles.pendingRequestsPage__title}
              textKey="amity_social_button_pending_requests"
            />
          </div>
