...
UiSuggestions.storyName = 'Simple suggestion list';
...
UiCustomSuggestion.storyName = 'Custom renderer';

UiCustomSuggestion.args = {
  query: '',
  items: [
    'lightsalmon',
    'salmon',
