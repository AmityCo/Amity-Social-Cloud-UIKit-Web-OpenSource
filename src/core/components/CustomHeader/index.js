    ...
    <div className="flex flex-col border-y-2 border-cym-lightgrey gap-2  bg-cym-lightteal px-8">
      <div className="flex flex-row h-[70px] items-end">
        ...
        >
          ...
          <g>
            <path class="cls-1" d="M440.87,6.75h-4.1v-1.94h10.49v1.94h-4.1v10.41h-2.29V6.75Z" />
            <path
              class="cls-1"
        ...
        <div
          className="text-cym-teal uppercase cym-h-2 !leading-none ml-2
"
        >
          COMMUNITY
        </div>
        ...
        <div className="flex ml-auto gap-2 items-center">
          ...
          <p onClick={() => {}} className="xs:cym-p-1-sm md:cym-p-1 xl:cym-p-1-lg">
            Jackie Dias
          </p>
        </div>
      </div>

      <div className="cym-h-2 h-[52px] mt-20">
