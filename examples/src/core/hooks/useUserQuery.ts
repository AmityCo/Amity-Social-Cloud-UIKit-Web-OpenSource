...
import useUsersCollection from './collections/useUsersCollection';
...
// breaking changes
const useUserQuery = (term: Parameters<typeof UserRepository.getUsers>[0]) => {
  const { users, hasMore, loadMore } = useUsersCollection(term);
